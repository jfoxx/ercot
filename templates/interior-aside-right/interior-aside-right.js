...
/**
 * Interior-Aside-Right template.
 *
 * Builds a three-area layout inside main:
 *   1. Breadcrumb — full-width top row (auto-built)
 *   2. Content    — left column; all sections NOT marked aside
 *   3. Sidebar    — right column; section(s) where section-metadata has aside: true
 *
...
export default async function decorate(main) {
  ...
  layout.append(breadcrumbWrapper, contentArea, sidebar);
  main.append(layout);
